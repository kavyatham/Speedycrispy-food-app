...
def open_state(request):
    return render(request,'admin_app/open_state.html',{"sf":StateForm(),"sdata":StateModel.objects.all()})
...
def save_state(request):
    ...
    if sf.is_valid():
        ...
        return render(request,"admin_app/open_state.html",{"sf":sf})
...
def update_state(request):
    ...
    return render(request,"admin_app/open_state.html",{"update_data":d1,"sdata":StateModel.objects.all()})
...
def open_city(request):
    return render(request,'admin_app/open_city.html',{"sf":CityForm(),"sdata":CityModel.objects.all()})
...
def save_city(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "admin_app/open_city.html", {"sf": sf})
...
def open_area(request):
    return render(request, 'admin_app/open_area.html', {"sf": AreaForm(), "sdata": AreaModel.objects.all()})
...
def save_area(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "admin_app/open_area.html", {"sf": sf})


def open_type(request):
    return render(request, 'admin_app/open_type.html', {"sf": RestaurantTypeForm(), "sdata": RestaurantTypeModel.objects.all()})
...
def save_type(request):
    ...
    if sf.is_valid():
        ...
        return render(request, "admin_app/open_type.html", {"sf": sf})


def pending_res(request):
    rs = RestaurantModel.objects.filter(restro_status='pending')
    return render(request,"admin_app/pending_res.html",{"data":rs})
...
def show_approved_res(request):
    ...
    return render(request, "admin_app/approved_res.html", {"data": rs})


def show_cancel_res(request):
    rs = RestaurantModel.objects.filter(restro_status='cancel')
    return render(request, "admin_app/cancel_res.html", {"data": rs})