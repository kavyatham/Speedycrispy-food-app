...
def showMain(request):
    return render(request,"restaurant_app/main.html")


def registerPage(request):
    return render(request,"restaurant_app/register.html",{"rf":RestaurantForm()})
...
def save_res(request):
    ...
    if rf.is_valid():
        ...
        return render(request,"restaurant_app/register.html",{"rf":rf})


def restro_login(request):
    return render(request,"restaurant_app/restro_login.html",{"rf":RestroLoginForm()})
...
def restro_login_check(request):
    ...
    try:
        ...
        if res.restro_status == "pending":
            ...
            return render(request, "restaurant_app/restro_login.html", {"rf": RestroLoginForm(), "error": message})
        ...
        return render(request, "restaurant_app/restro_login.html", {"rf": RestroLoginForm(),"error":"Invalid User"})


def restro_home(request):
    return render(request,"restaurant_app/restro_home.html")